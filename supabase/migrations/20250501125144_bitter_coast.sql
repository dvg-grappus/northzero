/*
  # Fix Roadmap Milestone Constraints

  1. Changes
     - Drops the existing unique index that was causing conflicts
     - Creates a new index that allows multiple milestones per slot
     - Ensures each milestone ID is unique within a document and slot combination
